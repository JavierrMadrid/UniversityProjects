...
public class DetallesGlucosaActivity extends AppCompatActivity  implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    private String antesodespues="", momento, id, seleccionSpinner;
    private EditText editGlucosa, editComentario;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnEliminarToma) {
            ...
            managerGlucosa.modificar(id, txtFecha.getText().toString(), txtHora.getText().toString(), antesodespues, momento, Integer.valueOf(editGlucosa.getText().toString()), editComentario.getText().toString());
